...
# patients = ["03", "04", "05", "06", "07", "09"]
patients = ["02", "03", "04", "05", "06", "07", "08", "09"]
channels = 18
...
def saveSignalsOnDisk(signalsBlock, nSpectogram):
    ...
    np.save(FirstPartPathOutput + SecondPartPathOutput + '/' + isPreictal + '_' + str(
    ...
    legendOfOutput = legendOfOutput + str(nSpectogram - signalsBlock.shape[0]) + ' ' + str(
        nSpectogram - 1) + ' ' + SecondPartPathOutput + '/' + isPreictal + '_' + str(
...
def main():
    ...
    for indexPatient in range(0, len(patients)):
        ...
        for i in range(0, contI + 1):
            ...
            np.delete(interictaldata, np.s_[0:interictaldata.shape[1] - notUsed], axis=1)
